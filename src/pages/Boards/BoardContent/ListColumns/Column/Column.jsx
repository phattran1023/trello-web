...
function Column({ column }) {
  ...
  const dndKitColumnStyles = {
    ...
    transition,
    // Chiều cao phải luôn 100% vì nếu không sẽ lỗi khi kéo thả column ngắn sang column dài, lúc này phải kết hợp với {...listeners} nằm ở Box chứ không phải div cha
    height: '100%',
