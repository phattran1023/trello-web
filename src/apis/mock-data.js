export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Test data for Board 01',
    description: 'Hello World! This is a test board .',
    type: 'public', // 'private'
        ...
        cards: [
          {
            ...
            cover: 'https://cdn.tgdd.vn/Files/2021/04/16/1343844/tim-hieu-ve-giong-cho-shiba-nguon-goc-dac-diem-cach-nuoi-bang-gia-202203281503364263.jpg',
      ...
      },
      {
        ...
        cards: [
          { _id: 'card-id-04-placeholder-card',
            ...
            FE_PlaceholderCard: true // Đây là card placeholder, không có thực tế
          }
        ]
      }
    ]
